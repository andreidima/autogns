        ...
        <div class="row card-header align-items-center" style="border-radius: 40px 40px 0px 0px;">
            ...
            <div class="col-lg-3 text-end">
                <a class="btn btn-sm bg-success text-white border border-dark rounded-3 col-md-8" href="{{ url()->current() }}/adauga" role="button">
                    <i class="fas fa-plus-square text-white me-1"></i>Adaugă noficare
                </a>
            </div>
        </div>
                        ...
                        @forelse ($notificari as $notificare)
                            <tr>
                                ...
                                <td class="text-center">
                                    {{ $notificare->data ? Carbon::parse($notificare->data)->isoFormat('DD.MM.YYYY') : '' }}
                                </td>
                                <td>
                                    <div class="d-flex justify-content-end">
                                        <a href="{{ $notificare->path() }}/modifica" class="flex me-1">
        ...
        <div class="modal fade text-dark" id="stergeNotificare{{ $notificare->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header bg-danger">
                    <h5 class="modal-title text-white" id="exampleModalLabel">Notificare: {{ $notificare->nume }}</h5>
                    <button type="button" class="btn-close bg-white" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body" style="text-align:left;">
                    Ești sigur ca vrei să ștergi Notificarel?
                </div>
